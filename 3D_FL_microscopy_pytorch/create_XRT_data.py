...
params_3d_5_5_5_h = {'src_path': os.path.join('./data/sample4_pad', 'grid_concentration.npy'), 
                   'theta_st': tc.tensor(0).to(dev), 
                   'theta_end': tc.tensor(2 * np.pi).to(dev),
...
params_3d_64_64_64_h = {'src_path': os.path.join('./data/sample1_pad', 'grid_concentration.npy'), 
                   'theta_st': tc.tensor(0).to(dev), 
                   'theta_end': tc.tensor(2 * np.pi).to(dev),
