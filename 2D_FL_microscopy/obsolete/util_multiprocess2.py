...
def self_absorption_ratio_single_theta(P, src_path, sample_size, sample_size_l, n_theta, theta_ls, element_ls, att_cs_lib, n_det_energy_bins, n_det, det_pos_ls, theta):
    SA_ij = np.zeros((sample_size * sample_size, n_det_energy_bins))
...
def self_absorption_ratio(src_path, sample_size, sample_size_l, n_theta, theta_ls, element_ls, att_cs_lib, n_det_energy_bins, n_det, det_pos_ls):
    ...
    pfunc = partial(self_absorption_ratio_single_theta, P, src_path, sample_size, sample_size_l, n_theta, theta_ls, element_ls, att_cs_lib, n_det_energy_bins, n_det, det_pos_ls)
    with Pool(5) as p:
